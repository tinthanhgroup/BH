...
| `TinThanh_NhaCungCap_Sync.gs` | Đọc Sheet "Đầu mối CSVC" (mỗi tab = 1 chi nhánh, người dùng tự cập nhật tay) → `nhacungcap.json` — chi tiết [docs/module-nhacungcap.md](docs/module-nhacungcap.md) | `nhaCungCapSync`: 1 trigger `everyDays(7)` (1 lần/tuần) | `nhacungcap.json` |
